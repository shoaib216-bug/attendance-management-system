...
class Staff(UserMixin, db.Model):
    staff_id=db.Column(db.Integer, primary_key=True); name=db.Column(db.String(100), nullable=False); username=db.Column(db.String(50), unique=True, nullable=False); password=db.Column(db.String(255), nullable=False); branch=db.Column(db.String(50)); subject=db.Column(db.String(100)); contact_no=db.Column(db.String(15))
